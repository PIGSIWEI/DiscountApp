...
import com.discount.pigpigroad.discountapp.MinePage.ExchangeRecord.ExchangeRecordPage1;
import com.discount.pigpigroad.discountapp.MinePage.ExchangeRecord.ExchangeRecordPage2;
import com.discount.pigpigroad.discountapp.MinePage.ExchangeRecord.ExchangeRecordPage3;
...
public class MyTipOffActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mytipoff_layout);
        init();
    }
    /**
     * 初始化
    ...
    private void init() {
        ...
        list.add(new MyTipOffPage1());
        list.add(new MyTipOffPage2());
        list.add(new MyTipOffPage3());
