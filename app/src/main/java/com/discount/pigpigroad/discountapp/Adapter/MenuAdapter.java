package com.discount.pigpigroad.discountapp.Adapter;
...
/**
 * 右侧主界面ListView的适配器
 * Created by PIGROAD on 2018/3/20.
 */
...
public class MenuAdapter extends BaseAdapter {
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if (arg0 == selectItem) {
            ...
            holder.tv_name.setTextColor(context.getResources().getColor(R.color.clickColor));
        } else {
