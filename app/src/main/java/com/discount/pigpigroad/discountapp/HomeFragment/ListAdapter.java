...
public class ListAdapter extends BaseAdapter {
     ...
     */
    public ListAdapter(Context context,List<Map<String, String>> dataList, int resoure){
    ...
    public View getView(final int i, View view, final ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            util.tv_title=view.findViewById(R.id.tv_title);
            util.gridView2=view.findViewById(R.id.gridView2);
            // 增加额外变量
            view.setTag(util);
        }else {
        ...
        util.tv_title.setText(map.get("title"));
        special_id=map.get("special_id");
        GetData(special_id,view);
        return view;
    }
    class Util { // 自定义控件集合
        TextView tv_title;
    ...
    public void GetData(String id, final View view){
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(Response<String> response) {
                        ...
                        try {
                            ...
                            Adapter adapter=new Adapter(view.getContext(),dataList2,R.layout.gridview2_layout);
