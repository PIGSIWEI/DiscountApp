...
public class MyOrderPage2Adapter  extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MyOrderPage2Adapter(Context context, List<Object> data) {
    ...
    class MyViewHolderFooter extends RecyclerView.ViewHolder {
        private Button btn_cancel, btn_pay, btn_delete,btn_back,btn_notice;
