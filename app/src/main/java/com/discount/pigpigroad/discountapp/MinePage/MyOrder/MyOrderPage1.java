...
import com.discount.pigpigroad.discountapp.MinePage.MyOrder.Adapter.MyOrderPage1Adapter;
...
public class MyOrderPage1 extends Fragment {
    private String login_token;
    private GoodsOrderInfo goodsOrderInfo;
    private OrderGoodsItem orderGoodsItem;
    private List<Object> mDatas =new ArrayList<>();
    private MyOrderPage1Adapter adapter;
    private RecyclerView recyclerView;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.myorder_page1,container,false);
        return view;
    }
    ...
    private void init() {
        ...
        //recyleview初始化
        recyclerView=getActivity().findViewById(R.id.myorderpage1_recyclerview);
        //布局管理器
        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        layoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        recyclerView.setLayoutManager(layoutManager);
        //adapter
        adapter=new MyOrderPage1Adapter(getActivity(),mDatas);
    ...
    private void getData(){
        OkGo.<String>post(URL_BASE + "?request=private.order.my.order.list.get&platform=android&token=" + login_token+"&order_status=1&curpage=1")
                .tag(this)
