...
import com.discount.pigpigroad.discountapp.MinePage.MyOrder.AllOrderPage;
...
public class AllOrderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof MyViewHolderHeader) {
            ...
            if (Gdatas.getStatus().equals("0")){
                ((MyViewHolderHeader) holder).tv_state.setText("订单已取消");
            }else if (Gdatas.getStatus().equals("1")){
                ((MyViewHolderHeader) holder).tv_state.setText("");
            }else if (Gdatas.getStatus().equals("2")){
                ((MyViewHolderHeader) holder).tv_state.setText("付款中");
            }else if (Gdatas.getStatus().equals("3")){
                ((MyViewHolderHeader) holder).tv_state.setText("买家已付款");
            }else if (Gdatas.getStatus().equals("4")){
                ((MyViewHolderHeader) holder).tv_state.setText("");
            }else if (Gdatas.getStatus().equals("5")){
                ((MyViewHolderHeader) holder).tv_state.setText("待评价");
            }else if (Gdatas.getStatus().equals("6")){
                ((MyViewHolderHeader) holder).tv_state.setText("");
            }
            ...
            //获取订单类型
            //0为退款1为待付款2为支付中3为待发货4待收货5为待评价6已完成
            Log.i(PP_TIP,datas.getStatus());

            if (datas.getStatus().equals("0")) {
                ((MyViewHolderFooter) holder).btn_confirm.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_check.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_notice.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_back.setVisibility(View.GONE);
                ...
                ((MyViewHolderFooter) holder).btn_cancel.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_pay.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_notice.setVisibility(View.VISIBLE);
                ((MyViewHolderFooter) holder).btn_back.setVisibility(View.VISIBLE);
                ((MyViewHolderFooter) holder).btn_delete.setVisibility(View.GONE);
            } else if (datas.getStatus().equals("4")) {
                ((MyViewHolderFooter) holder).btn_cancel.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_pay.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_confirm.setVisibility(View.VISIBLE);
                ((MyViewHolderFooter) holder).btn_check.setVisibility(View.VISIBLE);
                ((MyViewHolderFooter) holder).btn_notice.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_back.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_delete.setVisibility(View.GONE);
                ...
                ((MyViewHolderFooter) holder).btn_back.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_delete.setVisibility(View.GONE);
                ((MyViewHolderFooter) holder).btn_comment.setVisibility(View.GONE);
    ...
    class MyViewHolderFooter extends RecyclerView.ViewHolder {
        private Button btn_cancel, btn_pay, btn_delete,btn_back,btn_notice,btn_confirm,btn_check,btn_comment;
