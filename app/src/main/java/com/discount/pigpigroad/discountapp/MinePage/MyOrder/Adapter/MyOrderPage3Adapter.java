...
public class MyOrderPage3Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MyOrderPage3Adapter(Context context, List<Object> data) {
    ...
    class MyViewHolderFooter extends RecyclerView.ViewHolder {
        private Button btn_cancel, btn_pay, btn_delete,btn_confirm,btn_check;
